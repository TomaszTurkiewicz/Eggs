...
class ArrowDown (private val context: Context, private val width:Double, private val height:Double): Drawable(){
    ...
    private val a = Point((widthUnit*8).toInt(), (heightUnit*32).toInt())
    private val b = Point((widthUnit*12).toInt(), (heightUnit*17).toInt())
    private val c = Point((widthUnit*4).toInt(), (heightUnit*17).toInt())
