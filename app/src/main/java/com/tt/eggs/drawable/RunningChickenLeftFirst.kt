...
class RunningChickenLeftFirst (private val context: Context, private val width: Double): Drawable() {
    ...
    override fun draw(canvas: Canvas) {
        ...
        val c = Point((width*0.36).toInt(), (width*0.13).toInt())
        val curvedBC = Functions.curvedPath(b,c,unit*11,true)
        val d = Point((width*0.53).toInt(), (width*0.45).toInt())
        val curvedCD = Functions.curvedPath(c,d,unit*40,true)
        val e = Point((width*0.48).toInt(), (width*0.5).toInt())
        val curvedDE = Functions.curvedPath(d,e,unit*3,true)
        val f = Point((width*0.46).toInt(), (width*0.58).toInt())
        val curvedEF = Functions.curvedPath(e,f,unit*5,false)
        val g = Point((width*0.55).toInt(), (width*0.61).toInt())
        val curvedFG = Functions.curvedPath(f,g,unit*7,false)
        val h = Point((width*0.66).toInt(), (width*0.6).toInt())
        val curvedGH = Functions.curvedPath(g,h,unit*3,false)
        val i = Point((width*0.68).toInt(), (width*0.51).toInt())
        val curvedHI = Functions.curvedPath(h,i,unit,true)
        val j = Point((width*0.77).toInt(), (width*0.51).toInt())
        val curvedIJ = Functions.curvedPath(i,j,unit*17,true)
        val k = Point((width*0.81).toInt(), (width*0.56).toInt())
        val curvedJK = Functions.curvedPath(j,k,unit*5,false)
        val l = Point((width*0.86).toInt(), (width*0.61).toInt())
        val curvedKL = Functions.curvedPath(k,l,unit*5,true)
        val m = Point((width*0.82).toInt(), (width*0.76).toInt())
        val curvedLM = Functions.curvedPath(l,m,unit*5,true)
        val n = Point((width*0.81).toInt(), (width*0.85).toInt())
        val curvedMN = Functions.curvedPath(m,n,unit*5,true)
        val o = Point((width*0.79).toInt(), (width*1.01).toInt())
        val curvedNO = Functions.curvedPath(n,o,unit*5,false)
        val p = Point((width*0.9).toInt(), (width*1).toInt())
        val curvedOP = Functions.curvedPath(o,p,unit,true)
        val q = Point((width*0.92).toInt(), (width*1.06).toInt())
        val curvedPQ = Functions.curvedPath(p,q,unit*15,true)
        val r = Point((width*0.85).toInt(), (width*1.07).toInt())
        val curvedQR = Functions.curvedPath(q,r,unit*3,true)
        val s = Point((width*0.77).toInt(), (width*1.09).toInt())
        val curvedRS = Functions.curvedPath(r,s,unit*5,false)
        val t = Point((width*0.69).toInt(), (width*1.13).toInt())
        val curvedST = Functions.curvedPath(s,t,unit*5,true)
        val u = Point((width*0.63).toInt(), (width*1.1).toInt())
        val curvedTU = Functions.curvedPath(t,u,unit*5,true)
        val v = Point((width*0.71).toInt(), (width*1.04).toInt())
        val curvedUV = Functions.curvedPath(u,v,unit*5,true)
        val w = Point((width*0.65).toInt(), (width*0.99).toInt())
        val curvedVW = Functions.curvedPath(v,w,unit*15,false)
        val x = Point((width*0.53).toInt(), (width*0.99).toInt())
        val curvedWX = Functions.curvedPath(w,x,unit*9,true)
        val y = Point((width*0.39).toInt(), (width*0.95).toInt())
        val curvedXY = Functions.curvedPath(x,y,unit*11,false)
        val z = Point((width*0.39).toInt(), (width*1.03).toInt())
        val curvedYZ = Functions.curvedPath(y,z,unit*11,false)
        val a1 = Point((width*0.39).toInt(), (width*1.08).toInt())
        val curvedZA = Functions.curvedPath(z,a1,unit*9,true)
        val b1 = Point((width*0.31).toInt(), (width*1.07).toInt())
        val curvedAB1 = Functions.curvedPath(a1,b1,unit*7,true)
        val c1 = Point((width*0.14).toInt(), (width*0.91).toInt())
        val curvedBC1 = Functions.curvedPath(b1,c1,unit*5,false)
        val d1 = Point((width*0.21).toInt(), (width*0.84).toInt())
        val curvedCD1 = Functions.curvedPath(c1,d1,unit*17,true)
        val e1 = Point((width*0.35).toInt(), (width*0.79).toInt())
        val curvedDE1 = Functions.curvedPath(d1,e1,unit*40,false)
        val f1 = Point((width*0.37).toInt(), (width*0.66).toInt())
        val curvedEF1 = Functions.curvedPath(e1,f1,unit*3,true)
        val g1 = Point((width*0.35).toInt(), (width*0.57).toInt())
        val curvedFG1 = Functions.curvedPath(f1,g1,unit*5,true)
        val h1 = Point((width*0.15).toInt(), (width*0.45).toInt())
        val curvedGH1 = Functions.curvedPath(g1,h1,unit*13,true)
        val i1 = Point((width*0.14).toInt(), (width*0.37).toInt())
        val curvedHI1 = Functions.curvedPath(h1,i1,unit*5,true)
        val j1 = Point((width*0.06).toInt(), (width*0.27).toInt())
        val curvedIJ1 = Functions.curvedPath(i1,j1,unit*5,true)
        val k1 = Point((width*0.09).toInt(), (width*0.24).toInt())
        val curvedJK1 = Functions.curvedPath(j1,k1,unit*11,true)
        val l1 = Point((width*0.14).toInt(), (width*0.19).toInt())
        val curvedKL1 = Functions.curvedPath(k1,l1,unit*11,false)
        val m1 = Point((width*0.13).toInt(), (width*0.14).toInt())
        val curvedLM1 = Functions.curvedPath(l1,m1,unit,true)
        val curvedMA1 = Functions.curvedPath(m1,a,unit*7,true)
