...
class EggPlus225 (private val context: Context, private val size: Double): Drawable(){
    ...
    override fun draw(canvas: Canvas) {
        ...
        val a = Point((size*(0.5+dif)).toInt(), (size*(0.66+dif-up)).toInt())
        val b = Point((size*(0.5-dif)).toInt(), (size*(0.66-dif-up)).toInt())
        ...
        canvas.drawArc(mRect,225F,180F,false,paint)
