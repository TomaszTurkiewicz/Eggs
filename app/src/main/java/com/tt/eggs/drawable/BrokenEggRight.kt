...
class BrokenEggRight (private val context: Context, private val width: Double): Drawable() {
    ...
    override fun draw(canvas: Canvas) {
        ...
        val b = Point((width-(unit*0.7)).toInt(), (unit*0.55).toInt())
        ...
        val i = Point((width-(unit*1.1)).toInt(), (unit*1.05).toInt())
        val curvedRadiusHI = Functions.curvedPath(h,i,unit*0.05,false)
        val j = Point((width-(unit*1.15)).toInt(), (unit*1.12).toInt())
        val curvedRadiusIJ = Functions.curvedPath(i,j,unit*0.1,true)
        val k = Point((width-(unit*1.22)).toInt(), (unit*1.2).toInt())
        val curvedRadiusJK = Functions.curvedPath(j,k,unit*0.2,false)
        val l = Point((width-(unit*1.11)).toInt(), (unit*1.35).toInt())
        val m = Point((width-(unit*1.02)).toInt(), (unit*1.25).toInt())
        val curvedRadiusLM = Functions.curvedPath(l,m,unit*0.2,false)
        val n = Point((width-(unit*0.67)).toInt(), (unit*1.3).toInt())
        val curvedRadiusMN = Functions.curvedPath(m,n,unit*0.1,false)
        val o = Point((width-(unit*0.55)).toInt(), (unit*1.4).toInt())
        val curvedRadiusNO = Functions.curvedPath(n,o,unit*0.25,false)
        val p = Point((width-(unit*0.4)).toInt(), (unit*1.3).toInt())
        val q = Point((width-(unit*0.5)).toInt(), (unit*1.25).toInt())
        val curvedRadiusPQ = Functions.curvedPath(p,q,unit*0.2,false)
        val r = Point((width-(unit*0.55)).toInt(), (unit*1.2).toInt())
        val curvedRadiusQR = Functions.curvedPath(q,r,unit*0.1,true)
        val s = Point((width-(unit*0.47)).toInt(), (unit*1.05).toInt())
        ...
        val w = Point((width-(unit*0.5)).toInt(), (unit*0.8).toInt())
        val curvedRadiusVW = Functions.curvedPath(v,w,unit*0.1,true)
        val x = Point((width-(unit*0.58)).toInt(), (unit*0.73).toInt())
        val curvedRadiusWX = Functions.curvedPath(w,x,unit*0.02,false)
        val y = Point((width-(unit*0.5)).toInt(), (unit*0.6).toInt())
        val curvedRadiusXY = Functions.curvedPath(x,y,unit*0.05,true)
        val z = Point((width-(unit*0.25)).toInt(), (unit*0.35).toInt())
        val curvedRadiusYZ = Functions.curvedPath(y,z,unit*0.2,true)
        val z1 = Point((width-(unit*0.35)).toInt(), (unit*0.25).toInt())
        val curvedRadiusZZ1 = Functions.curvedPath(z,z1,unit*0.1,false)
        val z2 = Point((width-(unit*0.45)).toInt(), (unit*0.2).toInt())
        val curvedRadiusZZ2 = Functions.curvedPath(z1,z2,unit*0.2,false)
        ...
        val g1 = Point((width-(unit*2.6)).toInt(), (unit*2.5).toInt())
        ...
        val o1 = Point((width-(unit*1.4)).toInt(), (unit*2.4).toInt())
        val p1 = Point((width-(unit*1.65)).toInt(), (unit*2.25).toInt())
        ...
        paint.strokeWidth = (unit*0.1).toFloat()
        val c3 = Point((width-(unit*1.3)).toInt(), (unit*1.2).toInt())
        val d3 = Point((width-(unit*1.6)).toInt(), (unit*1.5).toInt())
        val e3 = Point((width-(unit*1.15)).toInt(), (unit*1.4).toInt())
        val f3 = Point((width-(unit*1.4)).toInt(), (unit*1.7).toInt())
