...
class RunningChickenRightTwo(private val context: Context, private val width: Double): Drawable() {
    ...
    override fun draw(canvas: Canvas) {
        ...
        val a = Point((width*0.7).toInt(), (width*0.55).toInt())
        ...
        val h = Point((width*0.18).toInt(), (width*1.32).toInt())
        val i = Point((width*0.0).toInt(), (width*1.20).toInt())
        val j = Point((width*0.40).toInt(), (width*1.44).toInt())
        ...
        val o = Point((width*0.4).toInt(), (width*0.3).toInt())
        val p = Point((width*0.55).toInt(), (width*0.45).toInt())
        val q = Point((width*0.35).toInt(), (width*0.55).toInt())
