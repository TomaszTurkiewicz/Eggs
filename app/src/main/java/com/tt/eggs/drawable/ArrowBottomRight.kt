...
class ArrowBottomRight (private val context: Context, private val width:Double, private val height:Double):Drawable(){
    ...
    private val a = Point((widthUnit*17).toInt(), (heightUnit*10).toInt())
    private val b = Point((widthUnit*15).toInt(), (heightUnit*14).toInt())
    private val c = Point((widthUnit*24).toInt(), (heightUnit*16).toInt())
