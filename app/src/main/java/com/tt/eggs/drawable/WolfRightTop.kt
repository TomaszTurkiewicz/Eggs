...
//
        ...
        a = Point((width-(width*0.2)).toInt(), (width*0.07).toInt())
        b = Point((width-(width*0.15)).toInt(), (width*0.1).toInt())
        radiusAB = Functions.curvedPath(a,b,unit*2,true)
        c = Point((width-(width*0.17)).toInt(), (width*0.13).toInt())
        radiusBC = Functions.curvedPath(b,c,unit*2,true)
        d = Point((width-(width*0.2)).toInt(), (width*0.115).toInt())
        radiusCD = Functions.curvedPath(c,d,unit,false)
        var radiusDA = Functions.curvedPath(d,a,unit*2,true)
        e = Point((width-(width*0.19)).toInt(), (width*0.17).toInt())
        var radiusCE = Functions.curvedPath(c,e,unit,true)
        f = Point((width-(width*0.24)).toInt(), (width*0.15).toInt())
        radiusEF = Functions.curvedPath(e,f,unit,false)
        g = Point((width-(width*0.24)).toInt(), (width*0.125).toInt())
        radiusFG = Functions.curvedPath(f,g,unit/2,false)
        var radiusGD = Functions.curvedPath(g,d,unit,true)
        h = Point((width-(width*0.215)).toInt(), (width*0.2).toInt())
        var radiusEH = Functions.curvedPath(e,h,unit,true)
        i = Point((width-(width*0.25)).toInt(), (width*0.18).toInt())
        radiusHI = Functions.curvedPath(h,i,unit,false)
        var radiusIF = Functions.curvedPath(i,f,unit/2,false)
        j = Point((width-(width*0.25)).toInt(), (width*0.07).toInt())
        var radiusDJ = Functions.curvedPath(d,j,unit*2,false)
        k = Point((width-(width*0.3)).toInt(), (width*0.09).toInt())
        radiusJK = Functions.curvedPath(j,k,unit*2,false)
        l = Point((width-(width*0.365)).toInt(), (width*0.27).toInt())
        m = Point((width-(width*0.345)).toInt(), (width*0.285).toInt())
        radiusLM = Functions.curvedPath(l,m,unit*7,false)
        n = Point((width-(width*0.3)).toInt(), (width*0.21).toInt())
        radiusMN = Functions.curvedPath(m,n,unit,false)
        o = Point((width-(width*0.28)).toInt(), (width*0.19).toInt())
        radiusNO = Functions.curvedPath(n,o,unit,true)
        p = Point((width-(width*0.26)).toInt(), (width*0.14).toInt())
        radiusOP = Functions.curvedPath(o,p,unit,false)
        var radiusPD = Functions.curvedPath(p,d,unit*5,true)
        ...
        a = Point((width-(width*0.16)).toInt(), (width*0.275).toInt())
        b = Point((width-(width*0.235)).toInt(), (width*0.26).toInt())
        radiusAB = Functions.curvedPath(a,b,unit*8,true)
        c = Point((width-(width*0.24)).toInt(), (width*0.22).toInt())
        radiusBC = Functions.curvedPath(b,c,unit,false)
        d = Point((width-(width*0.25)).toInt(), (width*0.22).toInt())
        radiusCD = Functions.curvedPath(c,d,unit,false)
        e = Point((width-(width*0.27)).toInt(), (width*0.28).toInt())
        radiusDE = Functions.curvedPath(d,e,unit,false)
        f = Point((width-(width*0.3)).toInt(), (width*0.33).toInt())
        radiusEF = Functions.curvedPath(e,f,unit/2,true)
        g = Point((width-(width*0.31)).toInt(), (width*0.34).toInt())
        radiusFG = Functions.curvedPath(f,g,unit/2,true)
        h = Point((width-(width*0.42)).toInt(), (width*0.41).toInt())
        i = Point((width-(width*0.41)).toInt(), (width*0.43).toInt())
        radiusHI = Functions.curvedPath(h,i,unit*11,false)
        j = Point((width-(width*0.34)).toInt(), (width*0.4).toInt())
        k = Point((width-(width*0.2)).toInt(), (width*0.39).toInt())
        radiusJK = Functions.curvedPath(j,k,unit*2,true)
        l = Point((width-(width*0.14)).toInt(), (width*0.39).toInt())
        radiusKL = Functions.curvedPath(k,l,unit,false)
        m = Point((width-(width*0.155)).toInt(), (width*0.375).toInt())
        radiusLM = Functions.curvedPath(l,m,unit*4,false)
        n = Point((width-(width*0.12)).toInt(), (width*0.34).toInt())
        radiusMN = Functions.curvedPath(m,n,unit,false)
        o = Point((width-(width*0.135)).toInt(), (width*0.325).toInt())
        radiusNO = Functions.curvedPath(n,o,unit*5,false)
        p = Point((width-(width*0.16)).toInt(), (width*0.34).toInt())
        radiusOP = Functions.curvedPath(o,p,1.0,false)
        q = Point((width-(width*0.165)).toInt(), (width*0.335).toInt())
        radiusPQ = Functions.curvedPath(p,q,unit*3,true)
        r = Point((width-(width*0.135)).toInt(), (width*0.305).toInt())
        radiusQR = Functions.curvedPath(q,r,1.0,true)
        var radiusRA = Functions.curvedPath(r,a,unit*9,false)
        ...
        a = Point((width-(width*0.09)).toInt(), (width*0.21).toInt())
        b = Point((width-(width*0.09)).toInt(), (width*0.04).toInt())
        radiusAB = Functions.curvedPath(a,b,unit*3,false)
        c = Point((width-(width*0.2)).toInt(), (width*0.05).toInt())
        radiusBC = Functions.curvedPath(b,c,unit*5,false)
        d = Point((width-(width*0.22)).toInt(), (width*0.08).toInt())
        radiusCD = Functions.curvedPath(c,d,0.0,false)
        e = Point((width-(width*0.21)).toInt(), (width*0.09).toInt())
        f = Point((width-(width*0.18)).toInt(), (width*0.07).toInt())
        radiusEF = Functions.curvedPath(e,f,unit*2,true)
        g = Point((width-(width*0.125)).toInt(), (width*0.055).toInt())
        radiusFG = Functions.curvedPath(f,g,unit*2,true)
        h = Point((width-(width*0.11)).toInt(), (width*0.13).toInt())
        radiusGH = Functions.curvedPath(g,h,unit*2,true)
        i = Point((width-(width*0.125)).toInt(), (width*0.2).toInt())
        radiusHI = Functions.curvedPath(h,i,unit/2,true)
        j = Point((width-(width*0.14)).toInt(), (width*0.21).toInt())
        radiusIJ = Functions.curvedPath(i,j,unit,true)
        k = Point((width-(width*0.2)).toInt(), (width*0.19).toInt())
        radiusJK = Functions.curvedPath(j,k,unit,false)
        l = Point((width-(width*0.21)).toInt(), (width*0.2).toInt())
        radiusKL = Functions.curvedPath(k,l,unit/2,true)
        m = Point((width-(width*0.25)).toInt(), (width*0.18).toInt())
        radiusLM = Functions.curvedPath(l,m,unit,false)
        n = Point((width-(width*0.245)).toInt(), (width*0.115).toInt())
        radiusMN = Functions.curvedPath(m,n,unit,false)
        o = Point((width-(width*0.28)).toInt(), (width*0.19).toInt())
        p = Point((width-(width*0.34)).toInt(), (width*0.28).toInt())
        q = Point((width-(width*0.3)).toInt(), (width*0.33).toInt())
        radiusPQ = Functions.curvedPath(p,q,unit,false)
        r = Point((width-(width*0.27)).toInt(), (width*0.28).toInt())
        radiusQR = Functions.curvedPath(q,r,unit,false)
        s = Point((width-(width*0.25)).toInt(), (width*0.22).toInt())
        radiusRS = Functions.curvedPath(r,s,unit,true)
        t = Point((width-(width*0.24)).toInt(), (width*0.22).toInt())
        radiusST = Functions.curvedPath(s,t,unit,true)
        u = Point((width-(width*0.235)).toInt(), (width*0.26).toInt())
        radiusTU = Functions.curvedPath(t,u,unit,true)
        v = Point((width-(width*0.16)).toInt(), (width*0.275).toInt())
        radiusUV = Functions.curvedPath(u,v,unit*8,false)
        var w = Point((width-(width*0.135)).toInt(), (width*0.305).toInt())
        var radiusVW = Functions.curvedPath(v,w,unit*9,true)
        var x = Point((width-(width*0.165)).toInt(), (width*0.335).toInt())
        var radiusWX = Functions.curvedPath(w,x,0.0,true)
        var y = Point((width-(width*0.135)).toInt(), (width*0.325).toInt())
        var radiusXY = Functions.curvedPath(x,y,0.0,false)
        var z = Point((width-(width*0.12)).toInt(), (width*0.34).toInt())
        var radiusYZ = Functions.curvedPath(y,z,unit*5,true)
        var a1 = Point((width-(width*0.145)).toInt(), (width*0.4).toInt())
        var b1 = Point((width-(width*0.05)).toInt(), (width*0.33).toInt())
        var radiusAB1 = Functions.curvedPath(a1,b1,unit*2,false)
        var c1 = Point((width-(width*0.03)).toInt(), (width*0.27).toInt())
        var radiusBC1 = Functions.curvedPath(b1,c1,unit*2,false)
        var d1 = Point((width-(width*0.05)).toInt(), (width*0.245).toInt())
        var radiusCD1 = Functions.curvedPath(c1,d1,unit,false)
        var e1 = Point((width-(width*0.09)).toInt(), (width*0.23).toInt())
        var radiusDE1 = Functions.curvedPath(d1,e1,0.0,true)
        var radiusEA1 = Functions.curvedPath(e1,a,unit,true)
