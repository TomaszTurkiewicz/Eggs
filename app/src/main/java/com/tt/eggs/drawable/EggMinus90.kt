...
class EggMinus90 (private val context: Context, private val size: Double): Drawable() {
    ...
    override fun draw(canvas: Canvas) {
        ...
        val a = Point((size*0.5).toInt(), (size*0.96).toInt())
        val b = Point((size*0.5).toInt(), (size*0.36).toInt())
        ...
        canvas.drawArc(mRect,270F,180F,false,paint)
